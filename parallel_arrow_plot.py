...
with PdfPages(pdf_filename) as pdf:
    fig, ax = plt.subplots(figsize=(11.7, 8.6))
    ...
    y_min = min(calculated_points['X_Mean'].min(), calculated_points['Y_Calculated_Mean'].min()) - 2
    y_max = max(calculated_points['X_Mean'].max(), calculated_points['Y_Calculated_Mean'].max()) + 2
